...
using AspNetCore_WebQuanLyQuanCafe.Services.Implements;
...
namespace AspNetCore_WebQuanLyQuanCafe
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            new SqlConnectDB(Configuration["Data:ConnectionString"]));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "AspNetCore_WebQuanLyQuanCafe v1"));
            }
