...
public class SPTrangChuAdapter extends RecyclerView.Adapter<SPTrangChuAdapter.PopularViewHolder>  {
    ...
    public SPTrangChuAdapter(Context context, ArrayList<DALThucDon> popularList) {
        this.context = context;
        this.popularList = popularList;
    }
    public SPTrangChuAdapter(Context context, ArrayList<DALThucDon> popularList, OnClickListener listener) {
        this.context = context;
        this.popularList = popularList;
    ...
    @NonNull
    @Override
    public SPTrangChuAdapter.PopularViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_1dong_trangchu, null);
        return new SPTrangChuAdapter.PopularViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SPTrangChuAdapter.PopularViewHolder holder, int position) {
...
//
//    public SPTrangChuAdapter(@NonNull Context context, @NonNull List<DALThucDon> objects) {
...
//    }
    ...
    public class PopularViewHolder extends RecyclerView.ViewHolder{
        ...
        public PopularViewHolder(@NonNull View itemView) {
            ...
            Img=itemView.findViewById(R.id.img_Hinh);
            LbTitle=itemView.findViewById(R.id.txt_name);
            LbContent=itemView.findViewById(R.id.txt_price);
